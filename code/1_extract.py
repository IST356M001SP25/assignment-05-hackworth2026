...
survey.to_csv('assignment05Hackworth2026/cache/survey.csv', index=False)
...
for year in years:
    ...
    col_year.to_csv(f'assignment05Hackworth2026/cache/col_{year}.csv', index=False)
...
state_table.to_csv('assignment05Hackworth2026/cache/states.csv', index=False)